...
const Navbar = () => {
  ...
  const navigation = [
    ...
    { title: "Symposium", path: "#" },
    { title: "IDSNY Intercity Rounds", path: "#" }
  ]
                ...
                >
                  <div class="group relative cursor-pointer">
                    <div class="flex items-center justify-between space-x-5 bg-white">
                      <a
                        class="menu-hover my-2 py-2 text-base font-medium mx-4"
                      >
                        More
                      </a>
                    </div>
                    <div class="invisible absolute z-50 flex w-full flex-col bg-gray-100 px-1 text-gray-800 shadow-xl group-hover:visible">
                      <a href='/about' class=" block border-b border-gray-100 py-1 font-semibold text-gray-500 hover:text-gray-900">About Us</a>
                      {/* <a class=" block border-b border-gray-100 py-1 font-semibold text-gray-500 hover:text-gray-900"></a> */}
                      {/* <a class=" block border-b border-gray-100 py-1 font-semibold text-gray-500 hover:text-gray-900"></a> */}
                    </div>
                  </div>
                </div>
